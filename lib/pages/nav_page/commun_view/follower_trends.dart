...
class FollowerTrends extends StatefulWidget {
  const FollowerTrends({Key? key}) : super(key: key);

  @override
  _NewTrendsState createState() => _NewTrendsState();
}

class _NewTrendsState extends State<FollowerTrends> with TickerProviderStateMixin,AutomaticKeepAliveClientMixin {
  @override
